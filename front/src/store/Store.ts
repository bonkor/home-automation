...
import HistView from './hist/viewModels';
...
import HistService from './hist/services';
...
class Store implements IStore {
    ...
    constructor() {
        ...
        this.viewModels.histView = new HistView();
        ...
        this.services.histService = new HistService(this);
    }
}
